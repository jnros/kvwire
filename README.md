...
Findings: Bandwidth knee at ~12KB. Per-token-per-layer (512B) dominated by overhead.  Move to per-token streaming is at 95% of saturation. Overlap peaks at 1.92X of theoretical 2X when Tc = Tx.
